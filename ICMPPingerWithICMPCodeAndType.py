	...
	try :
		while 1 :
			...
			if 'timedout' in delay :
				...
				replyDesc = "Reply Not Supported"
				if delay['type'] == 0 and delay['code'] == 0 :
					replyDesc = "Echo Reply"
				elif delay['type'] == 3 and delay['code'] == 0:
					replyDesc = "Dest. Network Unreachable"
				elif delay['type'] == 3 and delay['code'] == 1:
					replyDesc = "Dest. Host Unreachable"
				print("ICMP Type=%s, ICMP Code=%s: %s" % (delay['type'], delay['code'], replyDesc))
